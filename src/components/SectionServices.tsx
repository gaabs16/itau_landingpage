        ...
        <section className="relative w-full h-[965px]">
            <Container>
                <div className="flex-1 max-w-[594px] pt-32">
                    <span className="block text-primary-orange text-sm font-bold uppercase mb-9">serviço exclusivo</span>
                    ...
                    <ul className="flex flex-col items-start gap-9">
                        ...
                        <li className="flex items-center gap-9">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Acompanhe a fatura do seu cartão de credito e faça compras online com seu cartao virtual.</p>
                        </li>
                    </ul>
                </div>
            </Container>
